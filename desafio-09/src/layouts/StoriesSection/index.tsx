    ...
    <section className="bg-gray-100 pt-3 pb-20 px-8">
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col items-center">
          <h2 className="font-pangolin text-2xl md:text-3xl text-center max-w-72 md:max-w-96 mb-6">
            Os cães falam, mas apenas para quem sabe ouvir.
          </h2>
          <p className="font-roboto text-sm md:text-xl text-center md:max-w-2xl mb-8 md:mb-12">
